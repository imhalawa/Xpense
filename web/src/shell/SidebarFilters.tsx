...
const useStyles = makeStyles({
  ...
  sectionToggle: { flexGrow: 1, justifyContent: "flex-start", paddingInlineStart: tokens.spacingHorizontalXXS, color: tokens.colorNeutralForeground2 },
  add: { minWidth: "32px" },
  panel: { display: "flex", flexDirection: "column", gap: tokens.spacingVerticalXXS, paddingBlock: tokens.spacingVerticalXXS, paddingInlineStart: tokens.spacingHorizontalM },
