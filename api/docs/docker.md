...
| `XPENSE_DATA_MODE` | `LegacyClaim__DataMode` | Durable authority selector. Keep `legacy` through Task 32, then set `encrypted` only after the reviewed plaintext-removal cutover. |
